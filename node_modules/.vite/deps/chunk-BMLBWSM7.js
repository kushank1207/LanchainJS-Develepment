...
var BasePromptTemplate = class extends Runnable {
  ...
  static async deserialize(data) {
    switch (data._type) {
      case "prompt": {
        const { PromptTemplate: PromptTemplate2 } = await import("./prompt-IJJFVTAS.js");
      ...
      case "few_shot": {
        const { FewShotPromptTemplate } = await import("./few_shot-CKCEZ2DB.js");
...
//# sourceMappingURL=chunk-BMLBWSM7.js.map
